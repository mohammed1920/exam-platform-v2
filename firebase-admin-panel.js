...
section.querySelectorAll('[data-lawyer-view]').forEach(btn=>btn.addEventListener('click',()=>switchLawyerView(btn.dataset.lawyerView)));
  }
  ...
  async function loadLawyerApplications(){
    ...
    try{
      ...
      els.lawyersPendingCount.textContent=lawyerApplications.length;
  ...
  async function loadLawyerProfiles(){
    ...
    try{
      ...
      els.lawyersPublishedCount.textContent=lawyerProfiles.length;
